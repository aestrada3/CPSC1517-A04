...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table align="center" style="width: 80%; border: 1px solid #000000">
        ...
        <tr>
            <td align="right">
                <asp:Label ID="Label1" runat="server" Text="Choice (RadioButtonList):" ForeColor="Lime" Font-Bold="True"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td align="right">
                <asp:Literal ID="Literal1" runat="server" Text="Choice (via checkbox):"></asp:Literal>
            </td>
            <td>
